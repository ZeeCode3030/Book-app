...
function BookForm({ onAdd }) {
  ...
  function handleSubmit(e) {
    ...
    onAdd(form)
    setForm({ title: '', author: '', genre: '', rating: 0, review: '', dateRead: '' })
  }
  ...
  return (
    <form className="book-form" onSubmit={handleSubmit}>
      ...
      <label>Genre
        <input name="genre" value={form.genre} onChange={handleChange} placeholder="e.g. Fiction, Biography" />
      </label>

      <label>Date Read
        <input name="dateRead" type="date" value={form.dateRead} onChange={handleChange} />
      </label>
